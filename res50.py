...
try:
    ...
    torch.save(model_conv.state_dict(), os.path.join(net_path, "{}_model_val_{}".format(net_type, validation_folder + 1)))
    send_message("Training Finished. (ResNet50)")
except Exception as e:
    print(e)
    print("ResNet50 crashed...")
    send_message("ResNet50 crashed...")
